  ...
  return (
    ...
    >
      <div className="flex-1 text-center md:text-left z-[1]">
        <span className="text-xs md:text-sm text-blue-200 font-thin"></span>
      ...
      <div className="flex gap-2 justify-center md:gap-3 lg:gap-5 z-[1]">
        <div className="w-[403px] bg-gradient-to-br from-blue-950 to-slate-900 rounded-lg border border-blue-950 p-6">
          <div className="flex items-center justify-center">
            <img className="hero-img" src={PROFILE_PIC} alt="Profile" />
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <a href="https://github.com/mianmk81" target="_blank" rel="noopener noreferrer" className="bg-blue-800/30 p-2 rounded">
              <FaGithub className="text-lg md:text-xl" />
            </a>

            <a href="https://www.linkedin.com/in/mubashar-mian-770b2a224/" target="_blank" rel="noopener noreferrer" className="bg-blue-800/30 p-2 rounded">
              <FaLinkedin size={20} />
            </a>
